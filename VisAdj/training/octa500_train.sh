#!/bin/bash
# OCTA500 Training Script
# Adapted for OCTA500 benchmark dataset with 128x128 images
# Vessel network dataset with tree-like graphs
...
DATASET_ROOT="${DATASET_ROOT:-$PROJECT_ROOT/../dataset/processed/octa500_benchmark_128x128}"
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/octa500_edgewareGT_RGB_mean_topology_hid256}"

echo "=========================================="
echo "OCTA500 Training - 128x128 Images"
echo "=========================================="
echo "Dataset root: $DATASET_ROOT"
echo "Output directory: $OUTPUT_DIR"
echo "Image size: 128x128"
echo "Graph sizes: 2-20 nodes (mean: ~16, median: ~17)"
echo "Total samples: 1,786 (train: 1,247, val: 177, test: 362)"
echo "GPUs: 4"
echo "=========================================="
...
# OCTA500: 128x128 (same as 20cities and Toulouse)
IMAGE_SIZE=128
HEATMAP_RESOLUTION=16  # Scaled from 64: 64 * (128/512) = 16
NEIGHBOR_RADIUS=160.0  # Scaled from 512.0: 512 * (128/512) = 128
MASK_POOL_RADIUS=4     # Scaled from 16: 16 * (128/512) = 4

# Run training with OCTA500-adapted parameters
...
echo ""
echo "=========================================="
echo "OCTA500 training completed!"
echo "=========================================="
