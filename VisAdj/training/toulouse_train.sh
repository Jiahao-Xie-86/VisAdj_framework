#!/bin/bash
# Toulouse Training Script
# Adapted for Toulouse dataset with 128x128 images
# Graph sizes: 5-9 nodes (mean: 6.3, median: 6)
...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/toulouse_edgewareGT_RGB_mean_topology_hid256}"

echo "=========================================="
echo "Toulouse Training - 128x128 Images"
echo "=========================================="
echo "Dataset root: $DATASET_ROOT"
echo "Output directory: $OUTPUT_DIR"
echo "Image size: 128x128"
echo "Graph sizes: 5-9 nodes (mean: 6.3)"
echo "Total samples: 111,034"
echo "GPUs: 1"
echo "=========================================="
...
# Toulouse: 128x128 (vs SpaceNet: 400x400, Original: 512x512)
IMAGE_SIZE=128
...
# Run training with Toulouse-adapted parameters
...
echo ""
echo "=========================================="
echo "Toulouse training completed!"
echo "=========================================="
